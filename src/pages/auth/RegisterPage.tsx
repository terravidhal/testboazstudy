...
export default function RegisterPage() {
  ...
  function handleSubmit(e: FormEvent) {
    e.preventDefault()
    // À connecter au service/register mock plus tard
  }
      ...
      <div className="w-full max-w-xl">
        ...
        >
          ...
          <div className="text-center space-y-1">
            <h1 className="text-3xl font-bold text-[#0140ff]">Inscription</h1>
            <p className="text-sm text-[#646464]">Crée ton compte Boaz Study</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-[#565656]">Prénom</label>
              <input
                value={firstName}
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-[#565656]">Nom</label>
              <input
                value={lastName}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-[#565656]">
          ...
          <p className="text-xs text-center text-slate-500">
            Tu as déjà un compte ? Connecte-toi avec <span className="font-mono">demo@boaz.com</span> /{' '}
